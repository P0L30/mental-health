        ...
        <div className="bg-white" style={{ height: "265vh" }}>
            ...
            <div style={{ width: "100vw", height: "400px", }} className="flex justify-center items-center flex-row gap-40">
                <div className="flex justify-center items-center flex-col gap-2">
                    <p style={{ fontSize: "110px", fontFamily: "sans-serif", color: "black" }} className="font-bold">Our Vision</p>
                    <p style={{ fontSize: "20px", fontFamily: "sans-serif", color: "black" }}>Our vision is for people learn and fix there mental problems.<br /> And seek out help from others who have the same problems <br /> and seek out a answer together</p>
                </div>
            ...
            <div style={{ width: "100vw", height: "400px", border: "solid", borderColor: "black", borderBottomWidth: "2px", borderTopWidth: "2px" }} className="flex justify-center items-center flex-row gap-40">
                <div>
                    <p style={{ fontSize: "70px", fontFamily: "sans-serif", color: "black" }} className="font-bold">Where we came from</p>
                    <p style={{ fontSize: "20px", fontFamily: "sans-serif", color: "black" }}>MHChat was made by us as our group project.<br /> We made this website aftrer a long debait on what to make we came up with this. <br />We liked the ideaof others heping others with their storys and mor so we made this.</p>
                </div>
            </div>
            <div className="flex flex-row justify-center items-center mb-10 bt-10">
                <p style={{ fontSize: "100px", fontFamily: "sans-serif", color: "black" }}>Our Team</p>
                <img src="logo.png" style={{ width: "300px", height: "300px" }}></img>
            </div>
            <div style={{ width: "100vw", height: "400px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                ...
                <div className="justify-center items-center flex flex-row w-screen" style={{ height: "300px", borderColor: "black", border: "solid", borderBottomWidth: "2px" }}>
                    <div className="justify-center items-center flex flex-col w-screen" style={{ width: "220px", height: "300px", borderColor: "black", border: "solid", borderRightWidth: "2px", borderLeftWidth: "2px", paddingBottom: "100px", color: "black" }}><p className="font-bold" style={{ fontFamily: "sans-serif", fontSize: "30px", }}>Bat-Od</p><p>Team leader & <br /> back-end manager</p></div>
                    <div className="justify-center items-center flex flex-col w-screen" style={{ width: "220px", height: "300px", paddingBottom: "80px", color: "black" }}><p className="font-bold" style={{ fontFamily: "sans-serif", fontSize: "30px", color: "black" }}>Enkhmonkh</p><p>functionality <br /> manager</p></div>
                    <div className="justify-center items-center flex flex-col w-screen" style={{ width: "220px", height: "300px", borderColor: "black", border: "solid", borderLeftWidth: "2px", paddingBottom: "100px", color: "black" }}><p className="font-bold" style={{ fontFamily: "sans-serif", fontSize: "30px", }}>Davaasuren </p><p>web <br /> designer</p></div>
                    <div className="justify-center items-center flex flex-col w-screen" style={{ width: "220px", height: "300px", borderColor: "black", border: "solid ", borderaRightWidth: "2px", paddingBottom: "100px", color: "black" }}><p className="font-bold" style={{ fontFamily: "sans-serif", fontSize: "30px", }}>Buson</p><p>functionality <br />Developer</p></div>
                </div>
            </div>
        </div>
    )
